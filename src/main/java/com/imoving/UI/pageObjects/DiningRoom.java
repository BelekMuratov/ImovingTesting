...
public class DiningRoom {
    ...
    public WebElement addToInventoryButtonOnKitchenDiningChairs;
    @FindBy(xpath = "//div[@class='13']//a[@class='btn btn-blue'][normalize-space()='Add to Inventory']")
    public WebElement addToInventoryButtonOnKitchenAndDinigTable;
    @FindBy(xpath = "//div[@class='col-sm-9']")
    public WebElement saceAndGoToNextButton;
    ...
    public WebElement imageKitchenDinigTable;
}
